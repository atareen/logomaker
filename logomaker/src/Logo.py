...
from logomaker.logomaker.src import colors as lm_color
from logomaker.logomaker.src.validate import validate_matrix, validate_probability_mat
import logomaker.logomaker.src.validate as validate
from logomaker.logomaker.src.error_handling import check, handle_errors
